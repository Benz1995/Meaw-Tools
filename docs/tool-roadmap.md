...
## ผลจัดลำดับ Batch 10 และ Backlog
...
| 7 | Thai ID Checksum Validator | กลาง: Trends 8 | 2 | 4 | 4 | 3 | 2 | ตรวจ checksum เท่านั้น ไม่อ้างว่าเชื่อมฐานรัฐ และไม่บันทึกเลข |
...
9. Batch 11 — VAT, ใบเสนอราคา และ Sign PDF หลังทบทวนข้อกำหนดภาษี/เอกสารล่าสุด
