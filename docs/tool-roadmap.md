...
- รอบสิทธิและรายได้: `คำนวณเงินเดือน` 63, `คำนวณบำนาญ` 31, `คำนวณเงินเดือนข้าราชการ` 5, `คำนวณเงินชราภาพ` 3 และ `คำนวณค่าชดเชย` 1 แต่เลื่อนเครื่องมือบำนาญจนกว่าสูตร CARE จะมีหลักเกณฑ์บังคับใช้ที่ตรวจสอบได้ครบถ้วน
...
## ผลจัดลำดับ Batch 9 และ Backlog
...
| 3 | Pension Calculator | สูง: Trends 31 เทียบเงินเดือน 63 | 5 | 5 | 5 | 5 | 4 | รอหลักเกณฑ์ CARE ที่มีผลใช้จริงและตัวอย่างทางการครบถ้วน |
...
8. Batch 10 — วิจัย Pension/CARE ต่อ หากหลักเกณฑ์ยังไม่พร้อมให้เลือก CSV Cleaner หรือ PDF Organizer ที่ตรวจสอบได้ปลอดภัยกว่า
...
- Pension Calculator: demand สูง แต่สูตร CARE และช่วงเปลี่ยนผ่านต้องยืนยันจากกฎหมาย/ตัวอย่างทางการปัจจุบันก่อนเปิดตัว
