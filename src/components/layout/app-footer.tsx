...
export function AppFooter() {
  return (
    <footer className="meaw-shell-glass relative overflow-hidden border-t">
      <div className="mx-auto grid max-w-7xl gap-8 px-4 py-10 sm:px-6 md:grid-cols-[1.4fr_1fr_1fr]">
        ...
        <div><p className="text-sm font-semibold">ข้อมูลเว็บไซต์</p><ul className="mt-3 space-y-2 text-sm text-muted-foreground"><li><Link href="/categories">หมวดหมู่เครื่องมือ</Link></li><li><Link href="/professions">เครื่องมือตามสายอาชีพ</Link></li><li><Link href="/about">เกี่ยวกับเรา</Link></li><li><Link href="/privacy-policy">นโยบายความเป็นส่วนตัว</Link></li><li><Link href="/terms">ข้อกำหนดการใช้งาน</Link></li><li><Link href="/contact">ติดต่อ</Link></li></ul></div>
      </div>
