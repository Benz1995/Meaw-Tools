...
const components = {
  ...
  "flashcard-maker": dynamic(() => import("@/features/tools/flashcard-maker-tool").then((module) => module.FlashcardMakerTool), { loading, ssr: false }),
  ...
  "email-signature-generator": dynamic(() => import("@/features/tools/email-signature-generator-tool").then((module) => module.EmailSignatureGeneratorTool), { loading, ssr: false }),
  ...
  "debt-payoff-calculator": dynamic(() => import("@/features/tools/debt-payoff-calculator-tool").then((module) => module.DebtPayoffCalculatorTool), { loading, ssr: false }),
  ...
  "seating-chart-maker": dynamic(() => import("@/features/tools/seating-chart-maker-tool").then((module) => module.SeatingChartMakerTool), { loading, ssr: false }),
