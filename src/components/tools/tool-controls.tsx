...
export function WorkspaceFrame({ children, className }: { children: React.ReactNode; className?: string }) { return <div className={cn("meaw-workspace-panel rounded-2xl border p-4 sm:p-6", className)}>{children}</div>; }
