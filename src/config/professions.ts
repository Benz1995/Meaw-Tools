...
export const professionConfigs: ProfessionConfig[] = [
  {
    ...
    toolSlugs: ["json-formatter", "json-validator", "sql-formatter", "jwt-decoder", "uuid-generator", "timestamp-converter", "time-zone-meeting-planner", "time-blocking-planner", "habit-tracker", "online-notepad", "pomodoro-timer", "base64", "url-encoder", "regex-tester", "diff-checker", "cron-generator", "hash-generator", "markdown-table-generator", "html-table-generator", "color-picker", "password-generator"],
  },
  {
    ...
    toolSlugs: ["utm-builder", "time-zone-meeting-planner", "time-blocking-planner", "habit-tracker", "online-notepad", "pomodoro-timer", "countdown-timer", "email-signature-generator", "word-counter", "word-cloud-generator", "special-characters", "qr-code-generator", "qr-code-scanner", "barcode-generator", "color-picker", "percentage-calculator", "image-compressor", "background-remover", "favicon-generator", "profit-margin-calculator", "roas-calculator", "random-wheel"],
  },
  {
  ...
  },
  {
    ...
    toolSlugs: ["time-zone-meeting-planner", "time-blocking-planner", "habit-tracker", "online-notepad", "pomodoro-timer", "countdown-timer", "business-days-calculator", "working-hours-calculator", "meeting-cost-calculator", "billable-hours-calculator", "project-cost-calculator", "team-capacity-calculator", "labor-cost-calculator", "safety-stock-calculator", "eoq-calculator", "inventory-turnover-calculator", "break-even-calculator"],
  },
  {
    ...
    toolSlugs: ["time-blocking-planner", "habit-tracker", "online-notepad", "pomodoro-timer", "countdown-timer", "word-counter", "word-cloud-generator", "text-cleaner", "typing-test", "special-characters", "text-to-speech", "resume-builder", "email-signature-generator", "diff-checker", "image-to-text", "markdown-table-generator", "html-table-generator"],
  },
  {
    value: "education",
  ...
  },
  {
    ...
    toolSlugs: ["csv-to-excel", "excel-to-csv", "csv-cleaner", "resume-builder", "email-signature-generator", "time-zone-meeting-planner", "time-blocking-planner", "habit-tracker", "online-notepad", "pomodoro-timer", "quotation-generator", "invoice-generator", "merge-pdf", "split-pdf", "pdf-organizer", "sign-pdf", "image-to-text", "text-cleaner", "word-counter", "working-hours-calculator", "date-calculator", "thai-id-validator", "qr-code-scanner"],
  },
  {
