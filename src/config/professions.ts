...
export const professionConfigs: ProfessionConfig[] = [
  ...
  },
  {
    ...
    toolSlugs: ["utm-builder", "time-zone-meeting-planner", "time-blocking-planner", "habit-tracker", "online-notepad", "todo-list-online", "pomodoro-timer", "countdown-timer", "online-stopwatch", "email-signature-generator", "word-counter", "word-cloud-generator", "bingo-card-generator", "special-characters", "qr-code-generator", "qr-code-scanner", "barcode-generator", "color-picker", "percentage-calculator", "image-compressor", "background-remover", "favicon-generator", "profit-margin-calculator", "roas-calculator", "random-wheel"],
  },
  {
    ...
    toolSlugs: ["expense-tracker", "todo-list-online", "random-team-generator", "single-elimination-bracket-generator", "round-robin-schedule-generator", "bingo-card-generator", "budget-calculator", "bill-split-calculator", "vat-calculator", "quotation-generator", "invoice-generator", "email-signature-generator", "time-zone-meeting-planner", "time-blocking-planner", "profit-margin-calculator", "roas-calculator", "break-even-calculator", "wholesale-price-calculator", "unit-price-comparison-calculator", "inventory-turnover-calculator", "cost-of-goods-sold-calculator", "salary-calculator", "fuel-cost-calculator", "loan-calculator"],
  },
  {
