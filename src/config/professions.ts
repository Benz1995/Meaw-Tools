...
export const professionConfigs: ProfessionConfig[] = [
  ...
  },
  {
    ...
    toolSlugs: ["expense-tracker", "todo-list-online", "random-team-generator", "budget-calculator", "bill-split-calculator", "vat-calculator", "quotation-generator", "invoice-generator", "email-signature-generator", "time-zone-meeting-planner", "time-blocking-planner", "profit-margin-calculator", "roas-calculator", "break-even-calculator", "wholesale-price-calculator", "unit-price-comparison-calculator", "inventory-turnover-calculator", "cost-of-goods-sold-calculator", "salary-calculator", "fuel-cost-calculator", "loan-calculator"],
  },
  {
  ...
  },
  {
    ...
    toolSlugs: ["salary-calculator", "overtime-calculator-thailand", "social-security-pension-calculator", "working-hours-calculator", "shift-pattern-calculator", "labor-cost-calculator", "sales-commission-calculator", "team-capacity-calculator", "random-team-generator", "age-calculator", "thai-id-validator"],
  },
  {
    ...
    toolSlugs: ["time-zone-meeting-planner", "time-blocking-planner", "habit-tracker", "online-notepad", "todo-list-online", "pomodoro-timer", "online-alarm-clock", "countdown-timer", "online-stopwatch", "random-team-generator", "business-days-calculator", "working-hours-calculator", "meeting-cost-calculator", "billable-hours-calculator", "project-cost-calculator", "team-capacity-calculator", "labor-cost-calculator", "safety-stock-calculator", "eoq-calculator", "inventory-turnover-calculator", "break-even-calculator"],
  },
  {
  ...
  },
  {
    ...
    toolSlugs: ["online-alarm-clock", "interval-timer", "online-stopwatch", "countdown-timer", "habit-tracker", "todo-list-online", "bmi-calculator", "age-calculator", "percentage-calculator", "unit-converter", "random-team-generator", "random-number-generator", "random-wheel", "text-to-speech"],
  },
  {
  ...
  },
  {
    ...
    toolSlugs: ["csv-to-excel", "excel-to-csv", "csv-cleaner", "resume-builder", "email-signature-generator", "time-zone-meeting-planner", "time-blocking-planner", "habit-tracker", "online-notepad", "todo-list-online", "pomodoro-timer", "online-alarm-clock", "online-stopwatch", "random-team-generator", "quotation-generator", "invoice-generator", "merge-pdf", "split-pdf", "pdf-organizer", "sign-pdf", "image-to-text", "text-cleaner", "word-counter", "working-hours-calculator", "date-calculator", "thai-id-validator", "qr-code-scanner"],
  },
  {
