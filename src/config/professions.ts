...
export const professionConfigs: ProfessionConfig[] = [
  {
    ...
    toolSlugs: ["json-formatter", "json-validator", "sql-formatter", "jwt-decoder", "uuid-generator", "timestamp-converter", "time-zone-meeting-planner", "pomodoro-timer", "base64", "url-encoder", "regex-tester", "diff-checker", "cron-generator", "hash-generator", "markdown-table-generator", "html-table-generator", "color-picker", "password-generator"],
  },
  {
  ...
  },
  {
    ...
    toolSlugs: ["pomodoro-timer", "countdown-timer", "word-counter", "word-cloud-generator", "text-cleaner", "typing-test", "special-characters", "text-to-speech", "resume-builder", "email-signature-generator", "diff-checker", "image-to-text", "markdown-table-generator", "html-table-generator"],
  },
  {
    value: "education",
    ...
    toolSlugs: ["pomodoro-timer", "countdown-timer", "grade-calculator", "age-calculator", "percentage-calculator", "unit-converter", "buddhist-year-converter", "timestamp-converter", "bmi-calculator", "typing-test", "word-counter", "qr-code-generator", "text-to-speech", "jpg-to-pdf", "random-number-generator", "random-wheel"],
  },
  {
  ...
  },
  {
    ...
    toolSlugs: ["hourly-rate-calculator", "billable-hours-calculator", "project-cost-calculator", "quotation-generator", "invoice-generator", "email-signature-generator", "time-zone-meeting-planner", "pomodoro-timer", "thai-income-tax-calculator", "profit-margin-calculator", "meeting-cost-calculator", "resume-builder", "budget-calculator", "debt-payoff-calculator", "business-days-calculator"],
  },
  {
    value: "food-beverage",
